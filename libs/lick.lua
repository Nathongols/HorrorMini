...
local lick = {}
lick.debug = true                     -- show debug output
lick.reset = true                     -- reset the game and call love.load on file change
lick.clearFlag = true                 -- clear the screen on file change
...
lick.fileExtensions = { ".lua", ".glsl" }       -- file extensions to watch
...
local function variableUpdate(dt)
    checkFileUpdate()
